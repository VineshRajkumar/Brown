import { g as getDefaultExportFromCjs, c as reactDomExports, R as ReactDOM, u as useFloating, o as offset$2, s as shift$2, f as flip$2, d as size$2, e as arrow$2, h as hide$2, l as limitShift$2 } from "./react-dom-J4YzPou7.js";
...
function requireReactJsxRuntime_production_min() {
  ...
  var f = requireReact(), k = Symbol.for("react.element"), l2 = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, n2 = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p = { key: true, ref: true, __self: true, __source: true };
  function q(c, a2, g) {
  ...
  (function(exports) {
    ...
    function k(a2) {
      ...
      if (c !== b) {
        ...
        a: for (var d = 0, e2 = a2.length, w = e2 >>> 1; d < w; ) {
          ...
          if (0 > g(C, c)) n2 < e2 && 0 > g(x, C) ? (a2[d] = x, a2[n2] = c, d = n2) : (a2[d] = C, a2[m] = c, d = m);
          else if (n2 < e2 && 0 > g(x, c)) a2[d] = x, a2[n2] = c, d = n2;
          else break a;
        }
      }
      return b;
    ...
    function G(a2) {
      for (var b = h(t); null !== b; ) {
        ...
        else if (b.startTime <= a2) k(t), b.sortIndex = b.expirationTime, f(r2, b);
        else break;
        b = h(t);
      }
    }
    ...
    exports.unstable_scheduleCallback = function(a2, b, c) {
      ...
      e2 = c + e2;
      a2 = { id: u++, callback: b, priorityLevel: a2, startTime: c, expirationTime: e2, sortIndex: -1 };
      c > d ? (a2.sortIndex = c, f(t, a2), null === h(r2) && a2 === h(t) && (B ? (E(L), L = -1) : B = true, K(H, c - d))) : (a2.sortIndex = e2, f(r2, a2), A || z || (A = true, I(J)));
      return a2;
    };
...
function r$1(e2) {
  ...
  if ("string" == typeof e2 || "number" == typeof e2) n2 += e2;
    ...
    var o2 = e2.length;
    for (t = 0; t < o2; t++) e2[t] && (f = r$1(e2[t])) && (n2 && (n2 += " "), n2 += f);
  } else for (f in e2) e2[f] && (n2 && (n2 += " "), n2 += f);
  return n2;
}
function clsx() {
  for (var e2, t, f = 0, n2 = "", o2 = arguments.length; f < o2; f++) (e2 = arguments[f]) && (t = r$1(e2)) && (n2 && (n2 += " "), n2 += t);
  return n2;
}
...
Query.offset = (offset2) => new Query("offset", void 0, offset2).toString();
...
let AppwriteException$1 = class AppwriteException extends Error {
  /**
  ...
  call(method, url, headers = {}, params = {}, responseType = "json") {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (400 <= response.status) {
        throw new AppwriteException$1(data === null || data === void 0 ? void 0 : data.message, response.status, data === null || data === void 0 ? void 0 : data.type, data);
      }
...
Client$1.CHUNK_SIZE = 1024 * 1024 * 5;
class Service {
  constructor(client) {
    this.client = client;
  }
...
class Account {
  ...
  create(userId, email, password, name) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof userId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "userId"');
      }
      if (typeof email === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "email"');
      }
      if (typeof password === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "password"');
      }
      const apiPath = "/account";
      const payload = {};
      if (typeof userId !== "undefined") {
  ...
  deleteIdentity(identityId) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof identityId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "identityId"');
      }
  ...
  updateMFA(mfa) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof mfa === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "mfa"');
      }
  ...
  createMfaAuthenticator(type) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof type === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "type"');
      }
  ...
  updateMfaAuthenticator(type, otp) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (typeof otp === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "otp"');
      }
      const apiPath = "/account/mfa/authenticators/{type}".replace("{type}", type);
      const payload = {};
      if (typeof otp !== "undefined") {
  ...
  createMfaChallenge(factor) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof factor === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "factor"');
      }
  ...
  updateMfaChallenge(challengeId, otp) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof challengeId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "challengeId"');
      }
      if (typeof otp === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "otp"');
      }
  ...
  updateName(name) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof name === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "name"');
      }
  ...
  updatePhone(phone, password) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof phone === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "phone"');
      }
      if (typeof password === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "password"');
      }
  ...
  updatePrefs(prefs) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof prefs === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "prefs"');
      }
      const apiPath = "/account/prefs";
      const payload = {};
      if (typeof prefs !== "undefined") {
  ...
  createRecovery(email, url) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (typeof url === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "url"');
      }
  ...
  updateRecovery(userId, secret, password) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (typeof secret === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "secret"');
      }
      if (typeof password === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "password"');
      }
  ...
  createOAuth2Session(provider, success, failure, scopes) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof provider === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "provider"');
      }
  ...
  getSession(sessionId) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof sessionId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "sessionId"');
      }
  ...
  createPushTarget(targetId, identifier, providerId) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof targetId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "targetId"');
      }
      if (typeof identifier === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "identifier"');
      }
  ...
  listDocuments(databaseId, collectionId, queries) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof databaseId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "databaseId"');
      }
      if (typeof collectionId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "collectionId"');
      }
  ...
  createDocument(databaseId, collectionId, documentId, data, permissions) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (typeof documentId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "documentId"');
      }
      if (typeof data === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "data"');
      }
      const apiPath = "/databases/{databaseId}/collections/{collectionId}/documents".replace("{databaseId}", databaseId).replace("{collectionId}", collectionId);
      const payload = {};
      if (typeof documentId !== "undefined") {
  ...
  listFiles(bucketId, queries, search) {
    return __awaiter(this, void 0, void 0, function* () {
      if (typeof bucketId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "bucketId"');
      }
  ...
  createFile(bucketId, fileId, file, permissions, onProgress = (progress) => {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (typeof fileId === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "fileId"');
      }
      if (typeof file === "undefined") {
        throw new AppwriteException$1('Missing required parameter: "file"');
      }
      const apiPath = "/storage/buckets/{bucketId}/files".replace("{bucketId}", bucketId);
      const payload = {};
      if (typeof fileId !== "undefined") {
...
var configHandlers = function(editor, prevProps, props, boundHandlers, lookup) {
  return configHandlers2(
    ...
    function(handlerLookup, key) {
      return function(e2) {
        var _a2;
        return (_a2 = handlerLookup(key)) === null || _a2 === void 0 ? void 0 : _a2(e2, editor);
      };
    },
    prevProps,
    props,
  ...
  var loadScripts = function(items, success, failure) {
    ...
    for (var _i = 0, items_1 = items; _i < items_1.length; _i++) {
      ...
      if (existing) {
        ...
        injectScriptTag(doc, __assign$2({ id }, item), scriptLoadOrErrorHandler);
      }
    }
  };
  ...
  function(_super) {
    ...
    function Editor2(props) {
      ...
      _this.initialise = function(attempts) {
        ...
        var finalInit = __assign$1(__assign$1(__assign$1(__assign$1({}, _this.props.init), { selector: void 0, target, readonly: _this.props.disabled, inline: _this.inline, plugins: mergePlugins((_a3 = _this.props.init) === null || _a3 === void 0 ? void 0 : _a3.plugins, _this.props.plugins), toolbar: (_b2 = _this.props.toolbar) !== null && _b2 !== void 0 ? _b2 : (_c2 = _this.props.init) === null || _c2 === void 0 ? void 0 : _c2.toolbar }), _this.props.licenseKey ? { license_key: _this.props.licenseKey } : {}), { setup: function(editor) {
          _this.editor = editor;
          _this.bindHandlers({});
...
const ChevronDown = createLucideIcon("ChevronDown", __iconNode$1);
/**
 * @license lucide-react v0.476.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Toast = (props) => {
  ...
  }, (_icons_close = icons == null ? void 0 : icons.close) != null ? _icons_close : CloseIcon) : null, toastType || toast2.icon || toast2.promise ? /* @__PURE__ */ React.createElement("div", {
    "data-icon": "",
    className: cn(classNames == null ? void 0 : classNames.icon, toast2 == null ? void 0 : (_toast_classNames3 = toast2.classNames) == null ? void 0 : _toast_classNames3.icon)
  }, toast2.promise || toast2.type === "loading" && !toast2.icon ? toast2.icon || getLoadingIcon() : null, toast2.type !== "loading" ? toast2.icon || (icons == null ? void 0 : icons[toastType]) || getAsset(toastType) : null) : null, /* @__PURE__ */ React.createElement("div", {
    "data-content": "",
...
var PopperContent = reactExports.forwardRef(
  (props, forwardedRef) => {
    ...
    const { refs, floatingStyles, placement, isPositioned, middlewareData } = useFloating({
      ...
      middleware: [
        offset$2({ mainAxis: sideOffset + arrowHeight, alignmentAxis: alignOffset }),
...
function requireLib$2() {
  ...
  hasRequiredLib$2 = 1;
  (function(exports) {
    var __createBinding = lib$2 && lib$2.__createBinding || (Object.create ? function(o2, m, k, k2) {
      if (k2 === void 0) k2 = k;
  ...
  function formatDOM(nodes, parent, directive) {
    ...
    for (; index < nodesLength; index++) {
      ...
      switch (node2.nodeType) {
        ...
        case 3:
          current2 = new domhandler_1.Text(revertEscapedCharacters(node2.nodeValue));
          break;
        case 8:
...
function requireDomToReact() {
  ...
  function domToReact$1(nodes, options) {
    ...
    var _a2 = options.library || React2, cloneElement = _a2.cloneElement, createElement = _a2.createElement, isValidElement = _a2.isValidElement;
    var nodesLength = nodes.length;
...
const o$1 = globalThis.File, a$1 = globalThis.FormData, l = globalThis.fetch || (() => {
  throw new Error("[node-fetch-native] Failed to fetch: `globalThis.fetch` is not available!");
});
var o = Object.defineProperty;
var e = (t, c) => o(t, "name", { value: c, configurable: true });
var i = Object.defineProperty, r = e((t, c) => i(t, "name", { value: c, configurable: true }), "e");
function a() {
  return { agent: void 0, dispatcher: void 0 };
}
e(a, "createAgent"), r(a, "createAgent");
function n() {
  return globalThis.fetch;
}
e(n, "createFetch"), r(n, "createFetch");
var AppwriteException2 = class extends Error {
  constructor(message, code = 0, type = "", response = "") {
    super(message);
    this.name = "AppwriteException";
    this.message = message;
...
var _Client = class _Client2 {
  ...
  prepareRequest(method, url, headers = {}, params = {}) {
    ...
    let options = {
      method,
      headers,
      ...a(this.config.endpoint, { rejectUnauthorized: !this.config.selfSigned })
    };
    if (method === "GET") {
      ...
      switch (headers["content-type"]) {
        case "application/json":
          ...
          break;
        case "multipart/form-data":
          const formData = new a$1();
          for (const [key, value] of Object.entries(params)) {
            if (value instanceof o$1) {
              formData.append(key, value, value.name);
            } else if (Array.isArray(value)) {
              for (const nestedValue of value) {
                formData.append(`${key}[]`, nestedValue);
  ...
  async chunkedUpload(method, url, headers = {}, originalPayload = {}, onProgress) {
    const file = Object.values(originalPayload).find((value) => value instanceof o$1);
    ...
    while (start < file.size) {
      ...
      headers["content-range"] = `bytes ${start}-${end - 1}/${file.size}`;
      const chunk = file.slice(start, end);
      let payload = { ...originalPayload, file: new o$1([chunk], file.name) };
  ...
  async redirect(method, url, headers = {}, params = {}) {
    ...
    if (response.status !== 301 && response.status !== 302) {
      throw new AppwriteException2("Invalid redirect", response.status);
    }
  ...
  async call(method, url, headers = {}, params = {}, responseType = "json") {
    ...
    if (400 <= response.status) {
      throw new AppwriteException2(data == null ? void 0 : data.message, response.status, data == null ? void 0 : data.type, text);
    }
    return data;
  }
  static flatten(data, prefix = "") {
...
var Users = class {
  ...
  create(userId, email, phone, password, name) {
    if (typeof userId === "undefined") {
      throw new AppwriteException2('Missing required parameter: "userId"');
    }
    const apiPath = "/users";
    const payload = {};
    if (typeof userId !== "undefined") {
  ...
  createArgon2User(userId, email, password, name) {
    ...
    if (typeof email === "undefined") {
      throw new AppwriteException2('Missing required parameter: "email"');
    }
    if (typeof password === "undefined") {
      throw new AppwriteException2('Missing required parameter: "password"');
    }
  ...
  deleteIdentity(identityId) {
    if (typeof identityId === "undefined") {
      throw new AppwriteException2('Missing required parameter: "identityId"');
    }
  ...
  createScryptUser(userId, email, password, passwordSalt, passwordCpu, passwordMemory, passwordParallel, passwordLength, name) {
    ...
    if (typeof passwordSalt === "undefined") {
      throw new AppwriteException2('Missing required parameter: "passwordSalt"');
    }
    if (typeof passwordCpu === "undefined") {
      throw new AppwriteException2('Missing required parameter: "passwordCpu"');
    }
    if (typeof passwordMemory === "undefined") {
      throw new AppwriteException2('Missing required parameter: "passwordMemory"');
    }
    if (typeof passwordParallel === "undefined") {
      throw new AppwriteException2('Missing required parameter: "passwordParallel"');
    }
    if (typeof passwordLength === "undefined") {
      throw new AppwriteException2('Missing required parameter: "passwordLength"');
    }
  ...
  createScryptModifiedUser(userId, email, password, passwordSalt, passwordSaltSeparator, passwordSignerKey, name) {
    ...
    if (typeof passwordSaltSeparator === "undefined") {
      throw new AppwriteException2('Missing required parameter: "passwordSaltSeparator"');
    }
    if (typeof passwordSignerKey === "undefined") {
      throw new AppwriteException2('Missing required parameter: "passwordSignerKey"');
    }
  ...
  updateLabels(userId, labels) {
    ...
    if (typeof labels === "undefined") {
      throw new AppwriteException2('Missing required parameter: "labels"');
    }
  ...
  updateMfa(userId, mfa) {
    ...
    if (typeof mfa === "undefined") {
      throw new AppwriteException2('Missing required parameter: "mfa"');
    }
  ...
  deleteMfaAuthenticator(userId, type) {
    ...
    if (typeof type === "undefined") {
      throw new AppwriteException2('Missing required parameter: "type"');
    }
  ...
  updateName(userId, name) {
    ...
    if (typeof name === "undefined") {
      throw new AppwriteException2('Missing required parameter: "name"');
    }
  ...
  updatePhone(userId, number) {
    ...
    if (typeof number === "undefined") {
      throw new AppwriteException2('Missing required parameter: "number"');
    }
  ...
  updatePrefs(userId, prefs) {
    ...
    if (typeof prefs === "undefined") {
      throw new AppwriteException2('Missing required parameter: "prefs"');
    }
    const apiPath = "/users/{userId}/prefs".replace("{userId}", userId);
    const payload = {};
    if (typeof prefs !== "undefined") {
  ...
  deleteSession(userId, sessionId) {
    ...
    if (typeof sessionId === "undefined") {
      throw new AppwriteException2('Missing required parameter: "sessionId"');
    }
  ...
  updateStatus(userId, status) {
    ...
    if (typeof status === "undefined") {
      throw new AppwriteException2('Missing required parameter: "status"');
    }
  ...
  createTarget(userId, targetId, providerType, identifier, providerId, name) {
    ...
    if (typeof targetId === "undefined") {
      throw new AppwriteException2('Missing required parameter: "targetId"');
    }
    if (typeof providerType === "undefined") {
      throw new AppwriteException2('Missing required parameter: "providerType"');
    }
    if (typeof identifier === "undefined") {
      throw new AppwriteException2('Missing required parameter: "identifier"');
    }
    const apiPath = "/users/{userId}/targets".replace("{userId}", userId);
    const payload = {};
    if (typeof targetId !== "undefined") {
  ...
  updateEmailVerification(userId, emailVerification) {
    ...
    if (typeof emailVerification === "undefined") {
      throw new AppwriteException2('Missing required parameter: "emailVerification"');
    }
  ...
  updatePhoneVerification(userId, phoneVerification) {
    ...
    if (typeof phoneVerification === "undefined") {
      throw new AppwriteException2('Missing required parameter: "phoneVerification"');
    }
...
export {
  ...
  ScrollDownButton as a0,
  React as a1,
  Client2 as a2,
  Users as a3,
  parse as a4,
  useParams as a5,
  createBrowserRouter as a6,
  Provider_default as a7,
  RouterProvider2 as a8,
  size as b,
  reactExports as c,
...
//# sourceMappingURL=vendor-Bc5uPwhf.js.map
